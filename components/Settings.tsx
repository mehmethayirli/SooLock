  ...
  const handleChangeMasterPassword = async () => {
    try {
      ...
      const message = new TextEncoder().encode(
        "Change master password for Soolock"
      );
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        {/* Extension Token Section - New */}
        <div className="bg-black border border-[#c4ff9e] rounded-lg p-6">
          <div className="flex items-center mb-4">
            <Key className="h-6 w-6 text-[#c4ff9e] mr-3" />
            <h2 className="text-xl font-semibold text-[#c4ff9e]">
              Extension Access
            </h2>
          </div>
          <TokenScreen walletAddress={walletAddress} />
        </div>
        ...
        <div className="bg-black border border-[#c4ff9e] rounded-lg p-6">
          ...
          <p className="text-[#c4ff9e]/70 mb-4">
            Currently connected: {walletAddress.slice(0, 6)}...
        ...
        <div className="bg-black border border-[#c4ff9e] rounded-lg p-6">
          ...
          <div className="space-y-4">
            <label className="flex items-center justify-between p-3 border border-[#c4ff9e]/20 rounded-lg hover:bg-[#c4ff9e]/5">
              <div>
                <span className="text-[#c4ff9e] font-medium">
                  Auto-lock Vault
                </span>
                <p className="text-sm text-[#c4ff9e]/60">
            ...
            <label className="flex items-center justify-between p-3 border border-[#c4ff9e]/20 rounded-lg hover:bg-[#c4ff9e]/5">
              <div>
                ...
                <p className="text-sm text-[#c4ff9e]/60">
                  Sign all sensitive operations with wallet
                </p>
              </div>
              <input
                type="checkbox"
